...
#Test non character
print("Debug:Show warning in get.config.type(list())")
result <- tryCatch({
  print(suppressWarnings(get.config.type(list())))
}, error = function(e) {
  print(e)
})
print("Debug:Show warning in is.json.file(list())")
result <- tryCatch({
  print(suppressWarnings(is.json.file(list())))
}, error = function(e) {
  print(e)
})
print("Debug:Show warning in is.yaml.file(list())")
result <- tryCatch({
  print(suppressWarnings(is.yaml.file(list())))
}, error = function(e) {
  print(e)
})
print("Debug:Show warning in is.ini.file(list())")
result <- tryCatch({
  print(suppressWarnings(is.ini.file(list())))
}, error = function(e) {
  print(e)
})
print("Debug:Show warning in is.toml.file(list())")
result <- tryCatch({
...
print("Debug:Show FALSE in get.config.type(config.error.json)")
result <- tryCatch({
  print(suppressWarnings(get.config.type(config.error.json)))
}, error = function(e) {
  print(e)
})
print("Debug:Show FALSE in get.config.type(config.error.ini)")
result <- tryCatch({
  print(suppressWarnings(get.config.type(config.error.ini)))
}, error = function(e) {
  print(e)
})
print("Debug:Show FALSE in get.config.type(config.error.yaml)")
result <- tryCatch({
  print(suppressWarnings(get.config.type(config.error.yaml)))
}, error = function(e) {
  print(e)
})
print("Debug:Show FALSE in get.config.type(config.error.toml)")
result <- tryCatch({
  print(suppressWarnings(get.config.type(config.error.toml)))
}, error = function(e) {
  print(e)
})
print("Debug:Show FALSE in is.json.file(config.error.json)")
result <- tryCatch({
  print(suppressWarnings(is.json.file(config.error.json)))
}, error = function(e) {
  print(e)
})
print("Debug:Show FALSE in is.yaml.file(config.error.json)")
result <- tryCatch({
  print(suppressWarnings(is.yaml.file(config.error.json)))
}, error = function(e) {
  print(e)
})
print("Debug:Show FALSE in is.ini.file(config.error.json)")
result <- tryCatch({
  print(suppressWarnings(is.ini.file(config.error.json)))
}, error = function(e) {
  print(e)
})
print("Debug:Show FALSE in is.toml.file(config.error.json)")
result <- tryCatch({
...
print("Debug:Show Error in get.config.type(config.error.json, json.file.debug = TRUE)")
result <- tryCatch({
  print(suppressWarnings(get.config.type(config.error.json, json.file.debug = TRUE)))
}, error = function(e) {
  print(e)
})
print("Debug:Show Error in get.config.type(config.error.yaml, yaml.file.debug = TRUE)")
result <- tryCatch({
  print(suppressWarnings(get.config.type(config.error.yaml, yaml.file.debug = TRUE)))
}, error = function(e) {
  print(e)
})
print("Debug:Show Error in get.config.type(config.error.ini, ini.file.debug = TRUE)")
result <- tryCatch({
  print(suppressWarnings(get.config.type(config.error.ini, ini.file.debug = TRUE)))
}, error = function(e) {
  print(e)
})
print("Debug:Show Error in get.config.type(config.error.toml, toml.file.debug = TRUE)")
result <- tryCatch({
...
## *.file.debug test
print("Debug:Show TRUE in is.json.file(config.json, json.file.debug = T)")
result <- tryCatch({
  print(is.json.file(config.json, json.file.debug = T))
}, error = function(e) {
  print(e)
})
print("Debug:Show TRUE in is.ini.file(config.ini, ini.file.debug = T)")
result <- tryCatch({
  print(is.ini.file(config.ini, ini.file.debug = T))
}, error = function(e) {
  print(e)
})
print("Debug:Show TRUE in is.yaml.file(config.yaml, yaml.file.debug = T)")
result <- tryCatch({
  print(is.yaml.file(config.yaml, yaml.file.debug = T))
}, error = function(e) {
  print(e)
})
print("Debug:Show TRUE in is.toml.file(config.toml, toml.file.debug = T)")
result <- tryCatch({
...
print("Debug:Show warning in is.json.file(config.yaml, json.file.debug = T)")
result <- tryCatch({
  print(suppressWarnings(is.json.file(config.yaml, json.file.debug = T)))
}, error = function(e) {
  print(e)
})
print("Debug:Show warning in is.json.file(config.ini, json.file.debug = T)")
result <- tryCatch({
  print(suppressWarnings(is.json.file(config.ini, json.file.debug = T)))
}, error = function(e) {
  print(e)
})
print("Debug:Show warning in is.json.file(config.toml, json.file.debug = T)")
result <- tryCatch({
...
print("Debug:Show warning in is.ini.file(config.yaml, ini.file.debug = T)")
result <- tryCatch({
  print(suppressWarnings(is.ini.file(config.yaml, ini.file.debug = T)))
}, error = function(e) {
  print(e)
})
print("Debug:Show warning in is.ini.file(config.json, ini.file.debug = T)")
result <- tryCatch({
  print(suppressWarnings(is.ini.file(config.json, ini.file.debug = T)))
}, error = function(e) {
  print(e)
})
print("Debug:Show warning in is.ini.file(config.toml, ini.file.debug = T)")
result <- tryCatch({
...
print("Debug:Show warning in is.yaml.file(config.ini, yaml.file.debug = T)")
result <- tryCatch({
  print(suppressWarnings(is.yaml.file(config.ini, yaml.file.debug = T)))
}, error = function(e) {
  print(e)
})
print("Debug:Show warning in is.yaml.file(config.json, yaml.file.debug = T)")
result <- tryCatch({
  print(suppressWarnings(is.yaml.file(config.json, yaml.file.debug = T)))
}, error = function(e) {
  print(e)
})
print("Debug:Show warning in is.yaml.file(config.toml, yaml.file.debug = T)")
result <- tryCatch({
...
print("Debug:Show warning in is.toml.file(config.ini, toml.file.debug = T)")
result <- tryCatch({
  print(suppressWarnings(is.toml.file(config.ini, toml.file.debug = T)))
}, error = function(e) {
  print(e)
})
print("Debug:Show warning in is.toml.file(config.json, toml.file.debug = T)")
result <- tryCatch({
  print(suppressWarnings(is.toml.file(config.json, toml.file.debug = T)))
}, error = function(e) {
  print(e)
})
print("Debug:Show warning in is.toml.file(config.yaml, toml.file.debug = T)")
result <- tryCatch({
